<%-- 
    Document   : userLogged.jsp
    Created on : 8-Apr-2015, 11:21:35 PM
    Author     : c0650853
--%>
...
<script src="js/account.js"></script>
 ...
 <section class='container'>
     ...
     <h2>Select an Account</h2>
        <section>
                <select name="accounts" id="account_select">
                    <option></option>
               </select>
        </section>
        ...
        <section>
            <p>Account Name: <input id="account_name" /></p> 
            <p>Description: <textarea id="description" ></textarea></p>
            <p><button onclick="addAccount()">Add</button></p>
        </section>
